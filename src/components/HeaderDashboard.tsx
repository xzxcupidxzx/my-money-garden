...
export function HeaderDashboard({ summary, month }: HeaderDashboardProps) {
  ...
  return (
    <Card className="bg-gradient-to-br from-primary/10 via-primary/5 to-background border-0 shadow-lg">
